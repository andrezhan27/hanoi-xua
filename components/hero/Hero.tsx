  ...
  return (
    <section id="home" className="hero">
      <motion.div className="hero__media" initial={reducedMotion ? false : { opacity: 0, scale: 1.02 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1.2 }}>
        <Image className="hero__image hero__image--desktop" src="/images/hero-1.png" alt="Interior acolhedor do restaurante Hà Nội Xưa em Lisboa" fill priority sizes="100vw" />
        <Image className="hero__image hero__image--mobile" src="/images/hero-mobile.png" alt="Interior acolhedor do restaurante Hà Nội Xưa em Lisboa" fill priority sizes="100vw" />
      </motion.div>
